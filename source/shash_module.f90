...
module shash_module
   ...
   ! ---------
   ! x : real scalar
   !   The value at which to compute the SHASH cumulative distribution
   !   function (cdf).
   !
   ! loc : real scalar
   ...
   ! ---------
   ! x : real array
   !   The values at which to compute the SHASH cumulative distribution
   !   function (cdf).
   !
   ! loc : real scalar
   !   The location parameter.
   ...
   ! -------
   ! cdf : real array
   !   The computed cumulative distribution function evaluated at x. The
   !   returned cdf is the same size as x.
   !
   !---------------------------------------------------------------------------
   ...
   !   computation is also much faster than the quantile function.  As such,
   !   this function should be used in lieu of quantile(0.5, ...).
   !
   !---------------------------------------------------------------------------
   ...
   !   reformulation does not save significant computational time while
   !   severely sacrificing clarity.
   !
   !---------------------------------------------------------------------------
   ...
   ! References
   ! ----------
   ! [1] M. C. Jones and A. Pewsey. "Sinh-arcsinh distributions", Biometrika
   ! 96.4 October 2009, pp. 761–780. DOI: 10.1093/biomet/asp053.
   !
   !---------------------------------------------------------------------------
   ...
   !   a quadratic approximation around v = 0, a linear approximation
   !   around v = 1, and the standard forward recursion around v = 2, 3, ...
   !
   ...
   ! References
   ! ----------
   ! [1] S. Zhang and J. Jin. Computation of Special Functions. John Wiley
   ! and Sons, Inc., 1996. ISBN 978-0471119630.
   !
   !---------------------------------------------------------------------------
