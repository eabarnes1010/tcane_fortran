...
class Shash(tfp.distributions.SinhArcsinh):
    ...
    * The mean, skew, stddev, and variance defined by Shash MAY NOT
    ...
    def _convert_tfp_to_jones_and_pewsey(self):
        """Convert parameters from TensorFlow to Jones and Pewsey.
        ...
        * This conversion of the parameters is neccesary to use the detailed
        ...
        seamless, efficient, and somewhat invisible, implementation of shash2
        and shash3.
    ...
    def skew(self):
        ...
        Notes
        -----
        * This function is named "skew" to not overwrite the "skewness" parameter.

        * This function computes the "moment coefficient of skewness", also known
        as the "third standardized moment", also known as "Fisher's moment
        coefficient of skewness", also known as "Pearson's moment coefficient of
        skewness".  This function does NOT compute the excess skewness.
        ...
        * The E(X), E(X^2), and E(X^3) are computed using the moment equations
        ...
        stdY = eta * tf.math.sqrt(evX2 - evX * evX)

        return (
            evY3 - 3.0 * evY * tf.math.square(stdY) - tf.math.pow(evY, 3)
        ) / tf.math.pow(stdY, 3)
